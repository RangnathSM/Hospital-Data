         ...
         <Box display='flex' >
            ...
            <Box maxWidth='1030px' minHeight='100%' sx={{boxShadow : "0px 0px 4px 0px #00000033", border: "0px solid #1746A280", borderRadius:'15px', marginTop:{xl:'20px', lg:'20px', md:'20px', sm:'20px', xs:'20px'}, marginLeft:{xl:'0px', lg:'0px', md:'25px'}}} >
                ...
                <Table>
                    ...
                    <Typography align="left" sx={{fontSize:'20px', fontWeight:'500', color:'#1746A2',height:'30px',width:'150px', marginLeft:'25px'}} >Status</Typography>
                    <Typography align="left" sx={{fontSize:'20px', fontWeight:'500', color:'#1746A2',height:'30px',width:'135px', marginLeft:'-25px'}} >Date</Typography>
                    <Typography align="left" sx={{fontSize:'20px', fontWeight:'500', color:'#1746A2',height:'30px',}} >Due Date</Typography>
                    </Box>
                </TableCell>
                    </TableRow>
                    </TableHead>
                    ...
                    {clearedIncidents.map((request, index) => (
                       ...
                       <Box align="center" sx={{border: '1px solid #00A884', borderRadius:'30px',width:'130px', marginRight:'20px'}}>
                       <Typography align="start" sx={{fontSize:'16px', fontWeight:'500', color:'#00A884',height:'30px',width:'150px', borderColor:'black',display:'block', padding:'5px', marginLeft:'15px'}}>{request.Status}</Typography>
                       </Box>
                        ...
                        <Typography align="left" sx={{fontSize:'18px', fontWeight:'500', color:'#212427',height:'30px', borderColor:'black',display:'block', }}>{request.DueDate}</Typography>
                        </Box>
                        </TableCell>
                        </TableRow>
                    ))}
