...
const Hospital = () => {
    ...
    return ( 
        <Box  display='flex' maxWidth='100%' maxHeight='100%' sx={{background:'#FAF5EE',}}>
           <Box paddingY='20px' paddingX='0px' width={{xl:'800px', lg:'800px', md:'800px', sm:'550px', xs:'480px'}} height='100%' marginLeft={{xl:'160px', lg:'15px', md:'80px', sm:'20px'}}>
           ...
           <Box>
           <Box maxWidth='322px'>
            <Grid maxWidth='322px' maxHeight='370px' sx={{background:'white'}} marginTop='20px' borderRadius='20px' border= '1px solid #F7811740' boxShadow='0px 0px 4px 0px #0000001F' >
           ...
           <Box maxWidth='520px' marginLeft={{xl:'20px', lg:'20px', }} >
           <Box>
            ...
            <Box maxWidth='520px'>
                <Grid  maxWidth='520px' height='370px' sx={{background:'white'}} marginTop='20px' borderRadius='20px' border= '1px solid #F7811740' boxShadow='0px 0px 4px 0px #0000001F'>
                <Card sx={{borderRadius:'20px', border:'none', height:'100%'}}>
                <CardContent>
